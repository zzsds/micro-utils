...
// JeagerWrapper tracer wrapper
func JeagerWrapper(h http.Handler) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ext.HTTPStatusCode.Set(sp, uint16(http.StatusOK))
		if http.StatusOK >= http.StatusInternalServerError {
